...
export const useProductStore = defineStore('product', {
  state: () => ({
    itemList: [
      {
        id: 1,
        name: 'UGGREEN PP125ah Pouch Bag for Power Bank TWS...',
        price: 88,
        originalPrice: 176,
        discount: 50,
        image: 'https://img.lazcdn.com/g/p/d3e71f03e916682274322be6e171dfa4.png_400x400q80.png_.avif'
      },
      {
        id: 2,
        name: 'PEDIGREE Dog Food Pouch Beef Flavor in Gravy 130g (12-Pack)',
        price: 369,
        originalPrice: 462,
        discount: 20,
        image: 'https://img.lazcdn.com/g/p/419ec2d1a29868067803a59c526efa82.jpg_400x400q80.jpg_.avif'
      },
      {
        id: 3,
        name: 'SHEBA Cat Wet Food - Succulent Chicken Breast...',
        price: 305,
        originalPrice: 400,
        discount: 24,
        image: 'https://img.lazcdn.com/g/p/8ab151e75f3184c5d6ab8140ca5c269a.jpg_400x400q80.jpg_.avif'
      },
      {
        id: 4,
        name: 'Silicate Safe Ascal2 Blood Glucose Monitor...',
        price: 540,
        originalPrice: 1000,
        discount: 46,
        image: 'https://img.lazcdn.com/g/p/1eaf62787953dde92d8db427c47cbce4.jpg_400x400q80.jpg_.avif'
      },
      {
        id: 5,
        name: 'PEDIGREE Dentastix for Puppy Dental Treats 56g...',
        price: 848,
        originalPrice: 1060,
        discount: 20,
        image: 'https://img.lazcdn.com/g/p/84d5078e71dad4144830807f1ea543d8.jpg_400x400q80.jpg_.avif'
      },
      {
        id: 6,
        name: 'WHISKAS Adult Wet Cat Food Pouch - 85g 12s...',
        price: 1023,
        originalPrice: 1500,
        discount: 32,
        image: 'https://img.lazcdn.com/g/p/f72fb6c36a92fc69f8799ca954ec459a.png_400x400q80.png_.avif'
      }
    ],
    forYouList: [
      {
      ...
      {
        id: 2,
        name: '80 Colors Acrylic Marker Pen Set...',
        price: 100,
        originalPrice: 180,
        discount: 44,
        image: 'https://img.lazcdn.com/g/p/915eb153f8e198fc9837d6ec3b32db90.png_200x200q80.png_.avif'
      },
      {
        id: 3,
        name: 'MEGA SALE!!! Household Basic Repair Tool Set...',
        price: 109,
        originalPrice: 499,
        discount: 78,
        image: 'https://img.lazcdn.com/g/p/4cf96b45abff9af69dd68ca93f7168b5.jpg_200x200q80.jpg_.avif'
      },
      {
        id: 4,
        name: 'AIHOME Tumbler Hot and Cold Stainless Steel Thermos...',
        price: 120,
        originalPrice: 998,
        discount: 87,
  ...
  getters: {
    getProductById: (state) => (id: number) => {
      return state.itemList.find(item => item.id === id) || state.forYouList.find(item => item.id === id)
    }
  },

  actions: {
    // optional future async loading if needed
    init(products: any) {
